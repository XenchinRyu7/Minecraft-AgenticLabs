...
public class PromptBuilder {
    ...
    public static String buildSystemPrompt() {
        return """
            ...
            8. COLLABORATIVE BUILDING: Multiple agents can work on same structure simultaneously
    ...
    public static String buildUserPrompt(agentEntity agent, String command, WorldKnowledge worldKnowledge) {
        StringBuilder prompt = new StringBuilder();
        
        // Give agents FULL situational awareness
        prompt.append("=== YOUR SITUATION ===\n");
        prompt.append("Position: ").append(formatPosition(agent.blockPosition())).append("\n");
    ...
    private static String formatInventory(agentEntity agent) {
        return "[empty]";
    }
}
