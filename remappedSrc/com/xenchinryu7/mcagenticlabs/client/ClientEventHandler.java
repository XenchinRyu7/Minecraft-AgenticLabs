 ...
 */
@Mod.EventBusSubscriber(modid = "agent", bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
public class ClientEventHandler {
    ...
    public static void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (KeyBindings.TOGGLE_GUI != null && KeyBindings.TOGGLE_GUI.consumeClick()) {            agentGUI.toggle();
        }
    }
}
