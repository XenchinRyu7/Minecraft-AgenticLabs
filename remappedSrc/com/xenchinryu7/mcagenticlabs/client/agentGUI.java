...
public class agentGUI {
    ...
    public static void onRenderOverlay(RenderGuiOverlayEvent.Post event) {
        ...
        graphics.drawString(mc.font, "§lAgent AI", panelX + PANEL_PADDING, panelY + 8, TEXT_COLOR);
    ...
    private static void sendCommand(String command) {
        ...
        if (targetagents.isEmpty()) {
            var agents = agentMod.getAgentsManager().getAllAgents();
            if (!agents.isEmpty()) {
    ...
    private static List<String> parseTargetagents(String command) {
        ...
        if (commandLower.startsWith("all agents ") || commandLower.startsWith("all ") || 
            ...
            var allagents = agentMod.getAgentsManager().getAllAgents();
