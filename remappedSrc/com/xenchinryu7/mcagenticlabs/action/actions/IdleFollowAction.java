...
public class IdleFollowAction extends BaseAction {
    ...
    protected void onStart() {
        ...
        if (targetPlayer == null) {
            agentMod.LOGGER.debug("Agent '{}' has no player to follow (idle)", agent.getAgentName());
        }
    }
    ...
    protected void onTick() {
        ...
        if (distance > TELEPORT_DISTANCE) {
            ...
            agentMod.LOGGER.info("Agent '{}' teleported to player (was {} blocks away)", 
    ...
    private void findNearestPlayer() {
        ...
        if (nearest != targetPlayer && nearest != null) {
            agentMod.LOGGER.debug("Agent '{}' now following {} (idle)", 
