...
public class CombatAction extends BaseAction {
    ...
    protected void onStart() {
        ...
        if (target == null) {
            com.xenchinryu7.mcagenticlabs.AgentsMod.LOGGER.warn("Agent '{}' no targets nearby", agent.getAgentName());
        }
    }
    ...
    protected void onTick() {
        ...
        if (ticksRunning > MAX_TICKS) {
            ...
            com.xenchinryu7.mcagenticlabs.AgentsMod.LOGGER.info("Agent '{}' combat complete, invulnerability disabled", 
                agent.getAgentName());
        ...
        if (Math.abs(currentX - lastX) < 0.1 && Math.abs(currentZ - lastZ) < 0.1) {
            ...
            if (ticksStuck > 40 && distance > ATTACK_RANGE) {
                ...
                ticksStuck = 0;
                com.xenchinryu7.mcagenticlabs.AgentsMod.LOGGER.info("Agent '{}' was stuck, teleported closer to target", 
                    agent.getAgentName());
            }
        } else {
            ticksStuck = 0;
    ...
    protected void onCancel() {
        ...
        agent.setFlying(false);
        target = null;
        com.xenchinryu7.mcagenticlabs.AgentsMod.LOGGER.info("Agent '{}' combat cancelled, invulnerability disabled", 
            agent.getAgentName());
    }
    ...
    private void findTarget() {
        ...
        target = nearest;
        if (target != null) {
            com.xenchinryu7.mcagenticlabs.AgentsMod.LOGGER.info("Agent '{}' locked onto: {} at {}m", 
